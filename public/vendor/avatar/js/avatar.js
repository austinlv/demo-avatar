    ...
    CropAvatar.prototype = {
        ...
        submitDone: function (data) {
            ...
            if (data && !data.error) {
                ...
                this.showNotice('error', 'Fail to response');
            }
        },
        ...
        submitFail: function (data) {
            if (typeof (data.responseJSON) != 'undefined') {
                if (typeof (data.responseJSON.message) != 'undefined') {
                    this.showNotice('error', data.responseJSON.message);
                } else {
                    $.each(data.responseJSON, function (index, el) {
                        $.each(el, function (key, item) {
                            CropAvatar.prototype.showNotice('error', item);
                        });
                    });
                }
            } else {
                this.showNotice('error', data.statusText);
            }
        },
        ...
        showNotice: function (type, message) {
            if (type == 'success') {
                $('.crop-avatar .alert.alert-success').removeClass('hidden');
                $('.crop-avatar .alert.alert-success p').text(message);
            } else {
                $('.crop-avatar .alert.alert-danger').removeClass('hidden');
                $('.crop-avatar .alert.alert-danger p').text(message);
            }
        },
        hideNotice: function () {
            $('.crop-avatar .alert').addClass('hidden');
        }
    };
